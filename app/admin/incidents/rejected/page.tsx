...
export default async function AdminRejectedPage({
    ...
    if (queryError) {
        console.error(
            "[OpenWitness] Rejected incidents query failed:",
            JSON.stringify(
                {
        ...
        <div>
            <div className="mb-6">
                <h1 className="text-2xl font-bold tracking-tight">
                    প্রত্যাখ্যাত রিপোর্ট
                </h1>

                <p className="mt-1 text-sm text-zinc-500">
                    প্রত্যাখ্যাত ও বেসরকারি রিপোর্টসমূহ।
                </p>
            </div>
            ...
            {queryError ? (
                ...
                <IncidentList
                    ...
                    basePath="/admin/incidents/rejected"
                    currentParams={currentParams}
                    emptyMessage="কোনো প্রত্যাখ্যাত রিপোর্ট নেই।"
                />
            )}
        </div>
    );
